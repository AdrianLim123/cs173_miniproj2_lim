...
class RpcContractProvider extends operation_emitter_1.OperationEmitter {
    ...
    transferTicket(params) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (utils_2.validateAddress(params.destination) !== utils_2.ValidationResult.VALID) {
                throw new utils_2.InvalidAddressError(params.destination, 'param destination');
            }
            if (params.source && utils_2.validateAddress(params.source) !== utils_2.ValidationResult.VALID) {
                throw new utils_2.InvalidAddressError(params.source, 'param source');
            }
            const publicKeyHash = yield this.signer.publicKeyHash();
    ...
    smartRollupAddMessages(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const operation = yield prepare_1.createSmartRollupAddMessagesOperation(Object.assign(Object.assign({}, params), estimate));
            const ops = yield this.addRevealOperationIfNeeded(operation, publicKeyHash);
            const prepared = yield this.prepareOperation({ operation: ops, source: params.source });
            const opBytes = yield this.forge(prepared);
            const { hash, context, forgedBytes, opResponse } = yield this.signAndInject(opBytes);
            return new smart_rollup_add_messages_operation_1.SmartRollupAddMessagesOperation(hash, operation, publicKeyHash, forgedBytes, opResponse, context);
        });
    }
