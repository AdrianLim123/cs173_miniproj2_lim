...
import { DelegateParams, RevealParams, RegisterGlobalConstantParams, TransferParams, OriginateParams, TxRollupOriginateParams, TxRollupBatchParams, UpdateConsensusKeyParams, TransferTicketParams, IncreasePaidStorageParams, BallotParams, ProposalsParams, DrainDelegateParams, ParamsWithKind, SmartRollupAddMessagesParams } from '../operations/types';
...
export declare class PrepareProvider implements PreparationProvider {
     ...
     * @returns a PreparedOperation object
     */
    smartRollupAddMessages(params: SmartRollupAddMessagesParams, source?: string): Promise<PreparedOperation>;
    /**
     *
