...
import { FeeConsumingOperation, ForgedBytes, GasConsumingOperation, StorageConsumingOperation, RPCSmartRollupAddMessagesOperation } from './types';
/**
...
export declare class SmartRollupAddMessagesOperation extends Operation implements GasConsumingOperation, StorageConsumingOperation, FeeConsumingOperation {
    ...
    constructor(hash: string, params: RPCSmartRollupAddMessagesOperation, source: string, raw: ForgedBytes, results: OperationContentsAndResult[], context: Context);
