 ...
 */
export declare class UnsupportedPvmKindError extends Error {
    pvm: string;
    name: string;
 ...
 */
export declare class DecodePvmKindError extends Error {
    pvm: string;
    name: string;
    constructor(pvm: string);
}
 ...
 */
export declare class InvalidSmartRollupAddressError extends Error {
    address: string;
    name: string;
 ...
 */
export declare class InvalidSmartRollupContractAddressError extends Error {
    address: string;
    name: string;
    constructor(address: string);
}
